...
:::tip
If your organization does not have an existing RedHat account, you can create a RedHat trial account for a temporary OCP deployment (60 days). Instructions [here](/GettingStarted/prerequisites#redhat-ocp-account-and-pull-secret) under the expandable section "Obtain a RedHat Trial Account"
:::
...
[Download the OCPInstall_Role.yaml](/Cloudformation/OCPInstallRole.yaml)
