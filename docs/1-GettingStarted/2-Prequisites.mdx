...
- KeyPairName:
    :::note
    Key Pair generation instructions [here](/Deployment/installation#create-aws-keypair)
    :::
- RedhatPullSecret:
    :::note
    RedHat Pull Secret instructions [here](/Deployment/installation#obtain-redhat-pull-secret)
    :::
- DomainName:
- ClusterName:
