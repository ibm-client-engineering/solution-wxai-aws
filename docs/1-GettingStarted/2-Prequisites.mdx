...
- KeyPairName:
    :::note
    Key Pair generation instructions [here](/Deployment/Infrastructure/preparation#create-aws-keypair)
    :::
- RedhatPullSecret:
    :::note
    RedHat Pull Secret instructions [here](/Deployment/Infrastructure/preparation#obtain-redhat-pull-secret)
    :::
- DomainName:
- ClusterName:
