...
```
aws cloudformation deploy --stack-name stack-deployment-1 --template-file cluster-sts.yaml --parameter-overrides file://STS-parameters-override.json --capabilities CAPABILITY_NAMED_IAM --tags *add Key=Value tag here* --role-arn arn:aws:iam::<ACCOUNT>:/OCPInstall --disable-rollback
```
